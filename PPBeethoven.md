...
title: PPBeethoven
layout: template
filename: PPBeethoven.md FILE HERE
--- 
# Política de privacidad

**Pontificia Universidad Católica de Chile** elaboró la aplicación **Radio Beethoven** como una aplicación gratuita. Este SERVICIO es proporcionado por **Pontificia Universidad Católica de Chile** sin costo alguno y está destinado a ser utilizado tal cual.
...
Los términos utilizados en esta Política de privacidad tienen los mismos significados que en nuestros Términos y condiciones, a los que se puede acceder en **Radio Beethoven** a menos que se defina lo contrario en esta Política de privacidad.

  

**Recopilación y uso de información**

Para una mejor experiencia, mientras usa nuestro Servicio, puedo solicitarle que nos proporcione cierta información de identificación personal, que incluye, entre otros, Nombre, Dirección de correo electrónico y/o foto de usuario. La información solicitada es opcional, requerida exclusivamente para personalizar la experiencia creando una cuenta de usuario.
